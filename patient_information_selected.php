...
// Log user operation
logUserOperationToFile($user_id, 'Access', 'User accessed patient informationg selected page', date("Y-m-d H:i:s"));

// Use PDO to connect to Access Database
try {
    $dbPath = "D:\\phpstudy_pro\\WWW\\finalcode\\CC_Database.accdb";
...
$sql_str = "SELECT patient_id, name, age, gender, country FROM [Patient Information Data_A] 
            WHERE patient_id ORDER BY patient_id ASC";
